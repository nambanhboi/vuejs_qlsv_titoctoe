...
import { ADD_SINH_VIEN_ACTION, DELETE_SINH_VIEN_ACTION, EDIT_SINH_VIEN_ACTION, GET_SINH_VIEN_GETTER, GET_TEN_KHOA_GETTER, SET_SINH_VIEN_SEARCH_ACTION, GET_SINH_VIEN_SEARCH_GETTER } from '@/store/storeconstants';
...
export default {
    ...
    computed: {
        ...
        ...mapGetters('sv', {
            SinhVienSearchs: GET_SINH_VIEN_SEARCH_GETTER
        })
    },
    mounted() {
    ...
    methods: {
        ...
        ...mapActions('sv', {
            searchsinhvien: SET_SINH_VIEN_SEARCH_ACTION
        }),
        validateInput() {
        ...
        // },
        handleSearch() {
            this.searchsinhvien(this.inputsearch)
        }
